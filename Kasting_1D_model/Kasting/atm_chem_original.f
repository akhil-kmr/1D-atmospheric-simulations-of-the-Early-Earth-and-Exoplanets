...
C-AJ after using the correlated-k coefficient
         if(LBOUND(9).eq.2)SGFLUX(9) = -5.57E+09
         if(LBOUND(10).eq.2)SGFLUX(10) = 8.54E+10
         if(LBOUND(11).eq.2)SGFLUX(11) = 1.76E+11
         if(LBOUND(14).eq.2)SGFLUX(14) = 1.18E+09
         if(LBOUND(23).eq.2)SGFLUX(23) = 2.37E+08
