...
C  Temperature profile for O2=0.1 PAL (from Segura et al.,2003, Fig.2). Also replaced by Akhil to 100pc waccm data just in case
      DATA TP2/282.30, 276.89, 272.30, 266.84, 260.92, 
     &       254.46, 247.57, 240.42, 233.19, 226.33, 
     &       220.39, 215.83, 212.30, 209.36, 206.92, 
     &       205.40, 205.51, 207.28, 209.61, 211.81, 
     &       213.69, 215.42, 217.14, 218.89, 220.72, 
...
C-akhils version to query other species. 
      write(92,387) 
  387 format(/5x,'Z',9X,'PRESS',6x,'DEN',5x,'ProOH1',4x,'ProOH25',4x,
     ...
     4 5x,'PCH3CL',6x,'FOH',6x,'FHO2',6x,'FNO',5x,'FNO2',6x,'FH',
     5 4x,'FH2O2',5x,'FNO3',4x,'FN2O5',4x,'FHNO3',
     6 6x,'FO',7x,'FN',6x,'FH2',5x,'FCH4',4x,'FN2O')
     ...
     4 AR(53,I),AR(101,I),USOL(LOH,I),USOL(LHO2,I),USOL(LNO,I),
     5 USOL(LNO2,I),USOL(LH,I),USOL(LH2O2,I),USOL(LNO3,I),
     6 USOL(LN2O5,I),USOL(LHNO3,I),
     7 USOL(LO,I),USOL(LN,I),USOL(LH2,I),USOL(LCH4,I),USOL(LN2O,I),
     8 I=1,NZ)
  388 format(2x,1p32e10.3)
