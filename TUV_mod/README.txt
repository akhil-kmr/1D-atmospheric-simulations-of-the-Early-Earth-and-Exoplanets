...
NOTE (this installation): Stock NCAR documentation continues below.
For the Early-Earth multi-model UV comparison extension
(WACCM6 Pre_h0/Ten_h0/One_h0/Zero1_h0 + VULCAN/Photochem/Atmos/Kasting
via run_TUV.py), see README.md in this directory.
